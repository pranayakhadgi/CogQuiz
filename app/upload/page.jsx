      ...
      <div style={{ maxWidth: '500px', margin: '0 auto' }}>
        ...
        {cards.length === 0 && (
          ...
          >
            ...
            <p style={{ color:'#6B4226', fontWeight:'600', margin:'0 0 6px' }}>
              {uploading ? 'Generating your quiz...' : 'Drag & drop your PDF here'}
            </p>
            <p style={{ color:'#b09880', fontSize:'13px', margin:0 }}>
              {uploading ? 'This takes about 10–15 seconds' : 'or click to browse'}
            </p>
            <input
              id="fileInput"
              type="file"
        ...
        {uploading && (
          <div style={{ textAlign:'center', marginTop:'24px', color:'#8a6a50' }}>
            <div style={{
          ...
          <div>
            ...
            {cards[0] && (
              <div style={{
                ...
                <p style={{ color:'#3d2b1f', fontWeight:'600', margin:'0 0 12px' }}>
                  {cards[0].question}
                </p>
