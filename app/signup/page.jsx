    ...
    animation: 'breathe 10s ease-in-out infinite'
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '12px' }}>
          <label style={{ fontSize: '13px', color: '#8a6a50',
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <input
            ...
            style={{
              ...
              padding: '12px 14px',
              borderRadius: '10px',
              border: `1px solid ${focused === 'confirm' ? '#8B5E3C' : '#d4c4b0'}`,
              backgroundColor: '#f5f0e8',
              color: '#3d2b1f',
              fontSize: '15px',
              outline: 'none',
              boxSizing: 'border-box',
              transition: 'all 0.2s ease',
              boxShadow: focused === 'confirm' ? '0 0 0 3px rgba(139,94,60,0.12)' : 'none'
            }}
          />
        </div>
        ...
        <button
          ...
          style={{
            width: '100%',
            padding: '13px',
            backgroundColor: loading ? '#a07850' : '#6B4226',
            color: '#fff8f0',
            border: 'none',
            borderRadius: '10px',
            fontSize: '15px',
